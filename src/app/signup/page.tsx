      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Sign up to start using YouTube Arsenal
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          {info && (
            <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md text-blue-700 dark:text-blue-200 text-sm">
              {info}
            </div>
          )}
